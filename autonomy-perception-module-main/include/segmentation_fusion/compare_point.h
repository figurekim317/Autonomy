...
private:
    ...
    void point_callback(const sensor_msgs::msg::PointCloud2::SharedPtr &input);
    ...
    void synchronize_data(const std::vector<autonomy_ros2_message::msg::NEUOccupancyGrid> grid_vec, const std::vector<autonomy_ros2_message::msg::NEUOccupancyGrid> ground_vec,
                          autonomy_ros2_message::msg::NEUOccupancyGrid::SharedPtr &custom_grid, autonomy_ros2_message::msg::NEUOccupancyGrid::SharedPtr &custom_ground, bool &sync);

    void synchronize_data(const std::vector<autonomy_ros2_message::msg::NEUOccupancyGrid> grid_vec, const std::vector<sensor_msgs::msg::PointCloud2> ground_vec,
                          autonomy_ros2_message::msg::NEUOccupancyGrid::SharedPtr &custom_grid, sensor_msgs::msg::PointCloud2::SharedPtr &custom_ground, bool &sync);

    void project_to_image(pcl::PointCloud<pcl::PointXYZI>::Ptr &pcl_input, const autonomy_ros2_message::msg::NEUOccupancyGrid::SharedPtr seg_input, pcl::PointCloud<pcl::PointXYZI>::Ptr &seg_output);

    void update_grid(nav_msgs::msg::OccupancyGrid::SharedPtr &grid, std::vector<int8_t> occupancy_data, rclcpp::Time stamp);
    void update_neu_grid(autonomy_ros2_message::msg::NEUOccupancyGrid::SharedPtr &grid, std::vector<int8_t> occupancy_classes, std::vector<float> occupancy_data, rclcpp::Time stamp);
    ...
    std::vector<sensor_msgs::msg::PointCloud2> m_point_cloud_data_vec;
